...
<body class="bg-s-grey/20">
  <main class="w-full max-w-[430px] mx-auto min-h-screen bg-s-white shadow-2xl flex flex-col">
    ...
    <div class="flex-1 flex flex-col gap-5 px-4 py-5">
      <h1 class="text-base font-semibold text-s-black">Edit Kunci</h1>
      ...
      <form action="" method="post" enctype="multipart/form-data" class="flex flex-col gap-5">
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-1.5">
            ...
            <input type="text" value="<?= $data['nama'] ?>" name="nama" id="nama" placeholder="Masukan Nama Kunci" required
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <input type="text" value="<?= $data['lokasi'] ?>" name="lokasi" id="lokasi" placeholder="Masukan Lokasi" required
              class="w-full h-[48px] px-4 rounded-lg border border-s-black/20 bg-s-white text-s-black placeholder:text-s-grey outline-none transition focus:border-ijo-500 focus:ring-2 focus:ring-ijo-400/40">
          </div>

          <div class="flex flex-col gap-1.5">
            <label for="penjaw" class="text-sm font-medium text-s-black">Penanggung Jawab</label>
            <input type="text" value="<?= $data['penjaw'] ?>" name="penjaw" id="penjaw" placeholder="Masukan Penanggung Jawab" required
              class="w-full h-[48px] px-4 rounded-lg border border-s-black/20 bg-s-white text-s-black placeholder:text-s-grey outline-none transition focus:border-ijo-500 focus:ring-2 focus:ring-ijo-400/40">
          </div>
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <textarea name="note" id="note" rows="3" placeholder="Note untuk Kunci"
              class="w-full px-4 py-3 rounded-lg border border-s-black/20 bg-s-white text-s-black placeholder:text-s-grey outline-none transition focus:border-ijo-500 focus:ring-2 focus:ring-ijo-400/40"><?= $data['note'] ?></textarea>
          </div>

          <div class="flex flex-col gap-1.5">
            <label for="foto" class="text-sm font-medium text-s-black">Foto Kunci</label>
            <label for="foto" class="cursor-pointer self-start">
              <img src="../../img/kunci/<?= $data['urlFoto'] ?>" id="foto-preview" class="object-cover w-[100px] h-[100px] border border-s-black/20 rounded-xl" alt="Foto Kunci">
            </label>
